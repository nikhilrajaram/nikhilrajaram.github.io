---
layout: page
title: "BCOR 2000: ACCTG & FINANCIAL ANALYS Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [12.55,31.41,37.42,13.02,5.6,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: RAYMOND MACFEE, NANCY CAROL STEC, RANDY DONALD JOHNSTON, VICTORIA JEAN MARSCHNER, STEVEN KARL ROCK, JONATHAN L ROGERS, JOSHUA RYAN NEIL, MICHAEL JARED WILLIS
...
**Sections** (and **number of sections**): 100, 200, 300, 800, 001, 32
