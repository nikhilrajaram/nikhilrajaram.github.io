---
layout: page
title: "IPHY 4200 Statistics"
comments: true
description: "blank"
keywords: "IPHY, 4200, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [47.8,34.63,12.68,2.44,2.44,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 21.8
...
**Instructors**: STITZEL, JERRY A

**Easiest instructor** (based on class grade): STITZEL, JERRY A

**Sections** (and **number of sections**): 001,010, 9
