...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [31.73,50.0,17.07,1.2,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: EMERY, WILLIAM J,LI, XINLIN,MOHSENI, KAMRAN,THAYER, JEFFREY P,BIRINGEN, SEDAT,CHU, XINZHAO

**Easiest instructor** (based on class grade): LI, XINLIN
