---
layout: page
title: "MSBX 5450 Statistics"
comments: true
description: "blank"
keywords: "MSBX, 5450, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [62.5,37.5,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 9.64
...
**Instructors**: RINGWALD, CHRISTOPHER EARL

**Easiest instructor** (based on class grade): RINGWALD, CHRISTOPHER EARL
