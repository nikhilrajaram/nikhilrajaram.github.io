---
layout: page
title: "THTR 3035: PROD PRACTICUM-SCENERY Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [93.12,5.03,1.15,0.0,0.71,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: KERRY M CRIPE, STEVEN B MCDONALD, ROBERT J SHANNON, THEODORE STARK, AMY MICHELLE SCURA, CONSTANCE IRENE LANE, STEPHEN SCOTT VAN BALGOOYEN
...
**Sections** (and **number of sections**): 810, 812, 820, 830, 840, 821, 842, 71
