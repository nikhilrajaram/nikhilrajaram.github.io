...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [82.14,15.48,1.19,0.0,1.19,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: HUNTER, VICTORIA ASH,WIDENER, MELINDA CAIN

**Easiest instructor** (based on class grade): WIDENER, MELINDA CAIN
