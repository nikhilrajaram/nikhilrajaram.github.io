...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [32.43,64.86,2.7,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 4.49
...
**Instructors**: DE LANGHE, BART

**Easiest instructor** (based on class grade): DE LANGHE, BART
