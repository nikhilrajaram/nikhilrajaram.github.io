...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [37.5,40.0,10.0,7.5,5.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: SHANNON, JENNIFER A.

**Easiest instructor** (based on class grade): SHANNON, JENNIFER A.
