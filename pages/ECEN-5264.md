...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [51.61,48.39,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: GASIEWSKI, ALBIN J.

**Easiest instructor** (based on class grade): GASIEWSKI, ALBIN J.
