---
layout: page
title: "PSYC 4684 Statistics"
comments: true
description: "blank"
keywords: "PSYC, 4684, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [37.47,40.98,16.45,3.59,1.51,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: WADE, EILEEN GERILYN,SCHWARTZ, JENNIFER A. J.

**Easiest instructor** (based on class grade): SCHWARTZ, JENNIFER A. J.

**Sections** (and **number of sections**): 001,880,002, 20
