...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [85.12,11.9,1.79,0.6,0.6,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: ELLIOTT, SARAH E,MARTONIS, STEPHEN VINCENT

**Easiest instructor** (based on class grade): MARTONIS, STEPHEN VINCENT

**Sections** (and **number of sections**): 800, 11
