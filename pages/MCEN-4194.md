...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [76.74,23.26,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: LEE, SE-HEE

**Easiest instructor** (based on class grade): LEE, SE-HEE
