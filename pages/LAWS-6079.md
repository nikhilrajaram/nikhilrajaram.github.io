...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [46.45,52.9,0.65,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: ENGLAND, MARGARET ANN

**Easiest instructor** (based on class grade): ENGLAND, MARGARET ANN

**Sections** (and **number of sections**): 002,001,801, 13
