...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [64.29,25.51,5.1,1.02,4.08,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: GREEN, JEREMY F

**Easiest instructor** (based on class grade): GREEN, JEREMY F
