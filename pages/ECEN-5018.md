...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [80.0,16.67,1.67,0.0,1.67,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 24.59
...
**Instructors**: MARDEN, JASON R.,TOURI, BEHROUZ

**Easiest instructor** (based on class grade): MARDEN, JASON R.
