...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [25.0,66.91,4.41,0.0,3.68,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: DEMIREL, UFUK DEVRIM,BOILEAU, MARTIN

**Easiest instructor** (based on class grade): DEMIREL, UFUK DEVRIM
