...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [44.6,49.03,4.43,0.55,1.39,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
## Dimensions of Citizenship in the US and the EU
...
**Instructors**: MEWES, HORST,WHITE,CRAIG M

**Easiest instructor** (based on class grade): WHITE,CRAIG M
