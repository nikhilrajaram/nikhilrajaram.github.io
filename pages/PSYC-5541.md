...
**Standard deviation in grades**: 1.72
...
**Instructors**: MCCLELLAND, GARY,KELLER, MATTHEW C,YARKONI, TAL,GRUBER, JUNE L

**Easiest instructor** (based on class grade): YARKONI, TAL

**Sections** (and **number of sections**): 004,003,001,800, 6
