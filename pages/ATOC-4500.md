---
layout: page
title: "ATOC 4500: TPC-WTHR ANLY & FORECAST Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [55.38,37.34,6.01,0.32,0.95,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: KATJA FRIEDRICH, RICHARD ALAN KEEN, JULIE KAY LUNDQUIST, PETER ANDREW PILEWSKIE, KRISTOPHER BENSON KARNAUSKAS, CATRIN MILLS, ELIZABETH C WEATHERHEAD, JENNIFER E. KAY
