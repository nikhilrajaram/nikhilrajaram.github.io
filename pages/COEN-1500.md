...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [64.79,19.56,9.29,3.04,3.33,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: MILLER, SARAH M

**Easiest instructor** (based on class grade): MILLER, SARAH M

**Sections** (and **number of sections**): 101, 3
