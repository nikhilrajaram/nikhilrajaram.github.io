---
layout: page
title: "HONR 3001 Statistics"
comments: true
description: "blank"
keywords: "HONR, 3001, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [55.71,41.43,2.86,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: CAREY, CYNTHIA

**Easiest instructor** (based on class grade): CAREY, CYNTHIA

**Sections** (and **number of sections**): 880,881, 6
