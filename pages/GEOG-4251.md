...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [46.15,46.15,7.69,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 9.29
...
**Instructors**: PITLICK, JOHN

**Easiest instructor** (based on class grade): PITLICK, JOHN
