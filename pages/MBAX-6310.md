...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [42.42,57.58,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: DUNCAN, CALVIN P

**Easiest instructor** (based on class grade): DUNCAN, CALVIN P
