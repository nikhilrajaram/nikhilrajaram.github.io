...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [34.39,62.46,3.16,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: GODESIABOIS, JOY MARIE,STOCKTON, KEITH MICHAEL,MILLER, JANE S,MUELLER, ERICK MICHAEL,SALAMATIAN,TALLIS A,CASS, DAVID M,PRINSTER, DAVID ANTHONY

**Easiest instructor** (based on class grade): STOCKTON, KEITH MICHAEL

**Sections** (and **number of sections**): 001,002,004,005,006,003, 17
