...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [94.86,5.14,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: WHITNEY, ANNE B,KAN, PUI FONG,BRENNAN,CHRISTINE

**Easiest instructor** (based on class grade): KAN, PUI FONG
