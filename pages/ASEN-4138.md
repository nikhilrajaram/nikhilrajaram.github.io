---
layout: page
title: "ASEN 4138 Statistics"
comments: true
description: "blank"
keywords: "ASEN, 4138, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [65.91,32.95,1.14,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: GERREN, DONNA SUE

**Easiest instructor** (based on class grade): GERREN, DONNA SUE
