...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [46.03,53.17,0.79,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: ZHANG, DAN

**Easiest instructor** (based on class grade): ZHANG, DAN
