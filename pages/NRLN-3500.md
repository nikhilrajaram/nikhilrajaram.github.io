...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [84.93,15.07,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
## Constructions of Knowledge in the Fields
...
**Instructors**: MCSHANE, PATRICIA JANE,WALKER, JAMES FRANKLIN

**Easiest instructor** (based on class grade): WALKER, JAMES FRANKLIN

**Sections** (and **number of sections**): 490R, 6
