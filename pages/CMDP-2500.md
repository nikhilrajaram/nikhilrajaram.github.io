...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [81.58,13.16,2.63,2.63,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: CLARK,PATRICK RYAN,COOMBS ESMAIL,ERIC DAVID

**Easiest instructor** (based on class grade): CLARK,PATRICK RYAN
