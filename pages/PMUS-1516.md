---
layout: page
title: "PMUS 1516 Statistics"
comments: true
description: "blank"
keywords: "PMUS, 1516, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [89.88,8.93,0.89,0.0,0.3,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in instructor rating** (6 point scale): 2.49

**Instructors**: SILVER, DANIEL S

**Easiest instructor** (based on class grade): SILVER, DANIEL S
