...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [78.26,17.39,0.0,0.0,4.35,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: HUNTER, LORI MAE

**Easiest instructor** (based on class grade): HUNTER, LORI MAE
