---
layout: page
title: "HUEN 2120: History of Modern Science from Newton to Einstein Statistics"
comments: true
description: "blanks"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [52.17,36.25,10.03,0.0,1.55,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
