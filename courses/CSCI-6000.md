---
layout: page
title: "CSCI 6000: NEW PHD Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [91.76,7.14,1.1,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 10.04
...
**Instructors**: JOHN BLACK, DIRK C GRUNWALD, ELIZABETH BRADLEY, CLAYTON H LEWIS, JAMES H MARTIN, SRIRAM SANKARANARAYANAN
