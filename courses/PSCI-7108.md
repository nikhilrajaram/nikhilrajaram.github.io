---
layout: page
title: "PSCI 7108: TPC-ADV DATA ANALYSIS 3 Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [74.52,21.15,2.88,0.48,0.48,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: YING LU, JENNIFER LYNN WOLAK, JENNIFER L FITZGERALD, ANAND EDWARD SOKHEY, JOSEPH H JUPILLE, JEFFREY JOSEPH HARDEN, CAREW ELIZABETH BOULDING
...
**Sections** (and **number of sections**): 001, 004, 005, 002, 003, 17
