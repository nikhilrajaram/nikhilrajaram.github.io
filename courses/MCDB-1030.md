---
layout: page
title: "MCDB 1030: PLGUE/PEOPL/PLNTS/MCRORG Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [30.91,37.5,22.04,6.18,3.36,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 37.78
...
**Instructors**: DIANA OLIVERAS, MARIA CAROLINA PILONIETA, JENNIFER KIRSTEN KNIGHT, JIA SHI, BRIAN S DEDECKER
...
**Sections** (and **number of sections**): 785, 001, 710, 730, 170R, 880, 430R, 28
