...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [82.97,14.02,2.06,0.95,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: <a href='../../instructors/Maxwell_Thomas_Boykoff'>Maxwell Thomas Boykoff</a>, <a href='../../instructors/Mary_Beth_Osnes'>Mary Beth Osnes</a>
