---
layout: page
title: "MKTG 4850: SR SEMINAR IN MARKETING Statistics"
comments: true
description: "blank"
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [26.47,56.01,16.48,0.56,0.49,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: STEVEN P ENGEL, ATANU R SINHA, CALVIN P DUNCAN, MATJAZ BREN, JOHN G. LYNCH, MARY BETH LEWIS, EMILY JANE EDWARDS, KEVIN CHRISTOPHER MCMAHON
...
**Sections** (and **number of sections**): 002, 001, 003, 004, 36
