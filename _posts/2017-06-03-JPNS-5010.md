---
layout: post
title: "JPNS 5010 Statistics"
comments: true
description: "blank"
keywords: "JPNS, 5010, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [83.87,16.13,0.0,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: RODD, LAUREL RASPLICA

**Easiest instructor** (based on class grade): RODD, LAUREL RASPLICA
