---
layout: post
title: "ATOC 4770 Statistics"
comments: true
description: "blank"
keywords: "ATOC, 4770, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [66.0,22.0,8.0,0.0,4.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 32.2
...
**Instructors**: LUNDQUIST, JULIE KAY

**Easiest instructor** (based on class grade): LUNDQUIST, JULIE KAY
