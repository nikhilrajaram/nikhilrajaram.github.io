...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [32.34,47.9,16.17,1.8,1.8,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: ROOT, ELISABETH DOWLING,REID,COLLEEN ELIZABETH

**Easiest instructor** (based on class grade): ROOT, ELISABETH DOWLING
