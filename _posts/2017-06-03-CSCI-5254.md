...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [86.67,6.67,6.67,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: CHEN, LIJUN

**Easiest instructor** (based on class grade): CHEN, LIJUN
