...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [54.08,26.05,10.72,3.48,5.68,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 41.88
...
**Instructors**: MURATA, MINORI,AMBURY, BRADLEY JAY,SAEGUSA, KYOKO,MATSUNAGA, YUMIKO,ARIMA, YOSHIE,KANEYASU, MICHIKO

**Easiest instructor** (based on class grade): SAEGUSA, KYOKO

**Sections** (and **number of sections**): 001,002,003,004,005,006,007,008,009,010, 70
