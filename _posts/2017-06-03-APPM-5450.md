...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [67.24,31.03,0.86,0.86,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: LI, CONGMING,MARTINSSON, PER-GUNNAR J,BECKER, STEPHEN R

**Easiest instructor** (based on class grade): BECKER, STEPHEN R
