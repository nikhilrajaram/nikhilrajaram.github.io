...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [21.52,50.63,24.05,3.8,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: MOHR, PETER J

**Easiest instructor** (based on class grade): MOHR, PETER J

**Sections** (and **number of sections**): 003,009, 2
