---
layout: post
title: "MBAX 6110 Statistics"
comments: true
description: "blank"
keywords: "MBAX, 6110, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [63.69,34.52,1.59,0.0,0.2,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Standard deviation in grades**: 14.55
...
**Instructors**: LEACH, CHRIS,BAAS, ROY F

**Easiest instructor** (based on class grade): LEACH, CHRIS
