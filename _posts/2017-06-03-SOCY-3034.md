...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [29.98,44.39,17.73,4.35,3.2,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: WATTERWORTH, EARLE JAY,ROSGA, ANN JANETTE,GREATHOUSE, TANYA RENEE,MARTINEZ, KATHERINE,WORTHEM, JANICE M

**Easiest instructor** (based on class grade): MARTINEZ, KATHERINE

**Sections** (and **number of sections**): 010,001,100,002, 11
