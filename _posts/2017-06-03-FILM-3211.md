...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [58.46,36.92,3.08,0.0,1.54,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: AUGUISTE PH.D.,REECE LUKE

**Easiest instructor** (based on class grade): AUGUISTE PH.D.,REECE LUKE
