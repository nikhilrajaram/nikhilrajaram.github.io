---
layout: post
title: "FREN 1880 Statistics"
comments: true
description: "blank"
keywords: "FREN, 1880, CU, Boulder"
--- 
<head>
...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [42.96,39.26,14.81,1.48,1.48,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Proportion of students who dropped**: 6.16
...
**Instructors**: MURPHY, KIERAN MARCELLIN

**Easiest instructor** (based on class grade): MURPHY, KIERAN MARCELLIN
