...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [93.08,6.23,0.69,0.0,0.0,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: SMUTZLER, NATALIE D,STRIFE, SAMANTHA ROBERTS

**Easiest instructor** (based on class grade): STRIFE, SAMANTHA ROBERTS

**Sections** (and **number of sections**): 802,801, 20
