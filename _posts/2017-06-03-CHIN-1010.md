...
<body>
	...
	<script language="JavaScript">
		...
		var credits = {enabled: false};var series= [{name: 'Percent',data: [56.22,27.59,8.92,3.73,3.53,]}];
		var json = {};
		json.chart = chart;
		json.title = title;
...
**Instructors**: ZHAO, HUA,CHEN, JIN,NAVARRE, AMBER HSINYI,HSU, CHUN-LING,WANG, CHIUNG-YAO,QIAN,ZHIYING

**Easiest instructor** (based on class grade): WANG, CHIUNG-YAO

**Sections** (and **number of sections**): 001,002,003,004,005,006, 55
